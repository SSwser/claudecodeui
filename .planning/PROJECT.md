...
**清晰的组织管理** - 让用户能够轻松管理多个项目、stream 和会话,快速找到需要的对话,高效地在不同工作上下文间切换。如果只能做好一件事,就是让项目和会话的组织结构一目了然。
...
- [ ] **项目/Stream 管理** - 自动检测 git worktree,在项目选择界面显示所有工作树,支持 stream 概念
...
- [ ] **Stream 泳道** - 在看板视图中为每个 stream 分配独立泳道
