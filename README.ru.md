...
<p align="center">
  <a href="https://chorus.dev">Chorus Cloud</a> · <a href="https://chorus.dev/docs">Документация</a> · <a href="https://discord.gg/buxwujPNRE">Discord</a> · <a href="https://github.com/siteboon/claudecodeui/issues">Сообщить об ошибке</a> · <a href="CONTRIBUTING.md">Участие в разработке</a>
</p>
...
- **Система плагинов** - расширяйте Chorus кастомными плагинами — добавляйте новые вкладки, бэкенд-сервисы и интеграции. [Создать свой →](https://github.com/chorus-dev/chorus-plugin-starter)
...
**[Начать с Chorus Cloud](https://chorus.dev)**


### Self-Hosted (Open source)

Попробовать Chorus можно сразу через **npx** (требуется **Node.js** v22+):
...
Посетите **[документацию →](https://chorus.dev/docs)**, чтобы узнать про дополнительные варианты конфигурации, PM2, настройку удалённого сервера и многое другое
...
Chorus — это open source UI-слой, на котором построен Chorus Cloud. Вы можете развернуть его на своей машине или использовать Chorus Cloud, который добавляет полностью управляемую облачную среду, командные функции и более глубокие интеграции.
...
| **Настройка** | `npx @anthropic-ai/chorus` | Настройка не требуется |
...
> В обоих вариантах используются ваши собственные AI-подписки (Claude, Cursor и т.д.) — Chorus предоставляет среду, а не сам AI.
...
У Chorus есть система плагинов, которая позволяет добавлять кастомные вкладки со своим frontend UI и (опционально) Node.js бэкендом. Устанавливайте плагины напрямую из git-репозиториев в **Settings > Plugins** или создавайте свои.

### Доступные плагины

| Плагин | Описание |
|---|---|
| **[Project Stats](https://github.com/chorus-dev/chorus-plugin-starter)** | Показывает количество файлов, строки кода, разбивку по типам файлов, самые большие файлы и недавно изменённые файлы для текущего проекта |

### Создать свой

**[Plugin Starter Template →](https://github.com/chorus-dev/chorus-plugin-starter)** — сделайте форк этого репозитория, чтобы создать свой плагин. В шаблоне есть рабочий пример с рендерингом на фронтенде, live-обновлением контекста и RPC-коммуникацией с бэкенд-сервером.

**[Plugin Documentation →](https://chorus.dev/docs/plugin-overview)** — полный гайд по plugin API, формату манифеста, модели безопасности и другому.
...
Chorus и Chorus Cloud расширяют Claude Code, а не работают рядом с ним — ваши MCP-серверы, разрешения, настройки и сессии остаются теми же самыми, что и в нативном Claude Code. Ничего не дублируется и не управляется отдельно.

Вот что это означает на практике:

- **Все ваши сессии, а не одна** — Chorus автоматически находит каждую сессию из папки `~/.claude`. Remote Control предоставляет только одну активную сессию, чтобы сделать её доступной в мобильном приложении Claude.
- **Ваши настройки — это ваши настройки** — MCP-серверы, права инструментов и конфигурация проекта, изменённые в Chorus, записываются напрямую в конфиг Claude Code и вступают в силу сразу же, и наоборот.
...
- **Chorus Cloud работает в облаке** — закройте ноутбук, и агент продолжит работать. Не нужно следить за терминалом и держать машину постоянно активной.
...
Да. Chorus предоставляет среду, а не сам AI. Вы приносите свою подписку Claude, Cursor, Codex или Gemini. Chorus Cloud начинается от $7/месяц за хостируемую среду поверх этого.

</details>

<details>
<summary>Можно ли пользоваться Chorus с телефона?</summary>

Да. Для self-hosted запустите сервер на своей машине и откройте `[yourip]:port` в любом браузере в вашей сети. Для Chorus Cloud откройте сервис с любого устройства — без VPN, проброса портов и дополнительной настройки. Нативное приложение тоже в разработке.
...
Да, в self-hosted режиме. Chorus читает и записывает тот же конфиг `~/.claude`, который Claude Code использует нативно. MCP-серверы, добавленные через UI, сразу появляются в Claude Code, и наоборот.
...
- **[Документация](https://chorus.dev/docs)** — установка, настройка, возможности и устранение неполадок
