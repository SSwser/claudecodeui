...
import type { LandingPageData } from '../../main-content/types/types';
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Button
                ...
                className="h-11 rounded-pill border-brand/30 bg-brand text-brand-foreground shadow-subtle transition-colors hover:bg-brand/92 hover:opacity-100"
              >
              ...
              <Button
                ...
                className="h-11 rounded-small border-border/70 bg-surface-2/95 px-5 shadow-subtle transition-colors hover:bg-surface-3 hover:opacity-100"
              >
