		...
		<div className='space-y-4'>
			<div>
				<label className='mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300'>
					{workspaceType === 'worktree' ? t('projectWizard.step2.worktreePath') : t('projectWizard.step2.logicalPath')}
				</label>
				...
				<p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>
					{workspaceType === 'worktree' ? t('projectWizard.step2.worktreeHelp') : t('projectWizard.step2.logicalHelp')}
				</p>
			</div>
				...
				<>
					<div>
						...
						<Input
							...
							disabled={isCreating}
						/>
						<p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>{t('projectWizard.step2.sourcePathHelp')}</p>
					</div>
