...
export default function StepReview({ formState, selectedTokenName, isCreating, cloneProgress }: StepReviewProps) {
			...
			<div className='rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50'>
				...
				<div className='space-y-2'>
					...
					<div className='flex justify-between text-sm'>
						...
						<span className='break-all font-mono text-xs text-gray-900 dark:text-white'>{formState.workspacePath}</span>
					</div>
					...
					{formState.workspaceType === 'logical' && formState.githubUrl && (
						<>
							<div className='flex justify-between text-sm'>
								...
								<span className='break-all font-mono text-xs text-gray-900 dark:text-white'>{formState.githubUrl}</span>
							</div>
					...
					{formState.workspaceType === 'worktree' && (
						<>
							<div className='flex justify-between gap-3 text-sm'>
								<span className='text-gray-600 dark:text-gray-400'>{t('projectWizard.step3.sourcePath')}</span>
							...
							<div className='flex justify-between text-sm'>
								<span className='text-gray-600 dark:text-gray-400'>{t('projectWizard.step3.branchName')}</span>
								<span className='font-medium text-gray-900 dark:text-white'>{formState.branchName}</span>
							</div>

							<div className='flex justify-between text-sm'>
								<span className='text-gray-600 dark:text-gray-400'>{t('projectWizard.step3.baseBranch')}</span>
								<span className='font-medium text-gray-900 dark:text-white'>{formState.baseBranch}</span>
							</div>
						</>
					)}
				</div>
