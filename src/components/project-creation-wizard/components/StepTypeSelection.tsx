...
export default function StepTypeSelection({ workspaceType, onWorkspaceTypeChange }: StepTypeSelectionProps) {
	const { t } = useTranslation()

	return (
		<div className='space-y-4'>
			<h4 className='mb-3 text-sm font-medium text-gray-700 dark:text-gray-300'>{t('projectWizard.step1.question')}</h4>
			...
			<div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
				...
				>
					<div className='flex items-start gap-3'>
						...
						<div className='flex-1'>
							<h5 className='mb-1 font-semibold text-gray-900 dark:text-white'>{t('projectWizard.step1.new.title')}</h5>
