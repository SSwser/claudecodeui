...
import type { PreferenceToggleItem, PreferenceToggleKey, QuickSettingsPreferences } from '../types';
...
export default function QuickSettingsContent({
  ...
  return (
    <div
      className={`flex-1 space-y-6 overflow-y-auto overflow-x-hidden bg-background p-4 ${isMobile ? 'pb-mobile-nav' : ''}`}
    >
