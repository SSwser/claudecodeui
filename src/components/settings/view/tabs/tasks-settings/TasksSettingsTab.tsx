...
export default function TasksSettingsTab() {
  ...
  const { tasksEnabled, setTasksEnabled, isTaskMasterInstalled, isCheckingInstallation } =
        ...
        {isCheckingInstallation ? (
          ...
          <>
            {!isTaskMasterInstalled && (
              <div className="rounded-large border border-warning/35 bg-warning/10 p-4 shadow-subtle">
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-pill bg-warning/15">
                    <svg
                  ...
                  <div className="flex-1">
                    <div className="mb-2 font-medium tracking-ui text-foreground">
                      {t('tasks.notInstalled.title')}
                    </div>
                    <div className="space-y-3 text-sm tracking-body text-muted-foreground">
                      <p>{t('tasks.notInstalled.description')}</p>

                      <div className="rounded-medium border border-warning/25 bg-warning/10 p-3 font-mono text-sm text-foreground">
                      ...
                      <div>
                        <a
                          ...
                          className="inline-flex items-center gap-2 text-sm font-medium text-ring transition-opacity hover:opacity-60"
                        >
