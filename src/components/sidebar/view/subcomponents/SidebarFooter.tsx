      ...
      {updateAvailable && (
        <>
          ...
          <div className="hidden px-2 py-1.5 md:block">
            <button
              className="bg-brand/8 hover:bg-brand/12 dark:bg-brand/12 group flex w-full items-center gap-2.5 rounded-large border border-brand/20 px-2.5 py-2 text-left text-foreground shadow-subtle transition-colors dark:border-brand/30"
              onClick={onShowVersionModal}
            >
              <div className="relative flex-shrink-0">
                <ArrowUpCircle className="h-4 w-4 text-brand" />
                <span className="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 animate-pulse rounded-full bg-brand" />
              </div>
          ...
          <div className="px-3 py-2 md:hidden">
            <button
              className="bg-brand/8 hover:bg-brand/12 dark:bg-brand/12 flex h-11 w-full items-center gap-3 rounded-xl border border-brand/20 px-3.5 text-foreground shadow-subtle transition-all active:scale-[0.98] dark:border-brand/30"
              onClick={onShowVersionModal}
            >
              <div className="relative flex-shrink-0">
                <ArrowUpCircle className="h-4.5 w-4.5 text-brand" />
                <span className="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 animate-pulse rounded-full bg-brand" />
              </div>
